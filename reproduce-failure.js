...
try {
  ...
  // Import the actual proposer account (hex account) with initial balance
  const user = await worker.rootAccount.importContract({
    mainnetContract: 'dc1b16d8fb55c3dcec0f5f93bb673f4f9e1d3e8df1039004205b79f027539cee',
    initialBalance: '10000000000000000000000000'  // 10 NEAR for creating proposals
  });
  
  // Import two more Approver accounts to vote
